                ...
                <div className="px-8 mx-auto grid grid-cols-1 md:grid-cols-6 gap-8 relative z-10">
                    ...
                    <div className="md:col-span-5 mt-4">
                        ...
                        <div
                            ref={searchRef}
                            id="ai-search"
                            className="min-h-[70vh] flex flex-col md:flex-row gap-8 bg-[#061621] rounded-2xl p-12 mb-20"
                        >
                            <motion.div
                        ...
                        <div
                            ...
                            id="seamless-communication"
                            className="min-h-[70vh] flex flex-col md:flex-row gap-8 align-middle bg-[#061621] rounded-2xl p-12 mb-20"
                        >
                            <motion.div
                                initial={{ opacity: 0, x: -50 }}
                                animate={{
