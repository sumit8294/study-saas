...
export default function SoftwareOverviewPage() {
    ...
    const [elements, setElements] = useState([
        { id: 1, image: "/icons/dashboard.png", status: "Active" },
        { id: 2, image: "/icons/dashboard.png", status: "Active" },
        { id: 3, image: "/icons/dashboard.png", status: "Active" },
        { id: 4, image: "/icons/dashboard.png", status: "Active" },
        { id: 5, image: "/icons/dashboard.png", status: "Active" },
    ]);
    ...
    const filteredElements = elements.filter((el) =>
        el.id.toString().includes(searchTerm.toLowerCase())
    );
                        ...
                        <div className="flex items-center justify-between">
                            <div className="flex items-center space-x-3">
                                <button
                                    type="button"
                                    onClick={() =>
                                        setShowOnLanding(!showOnLanding)
                                    }
                            ...
                            <button className="flex items-center gap-2 px-4 py-2 bg-indigo-600 rounded-lg text-white hover:bg-indigo-500 transition">
